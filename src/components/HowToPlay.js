...
export default function HowToPlay({setHowToPlayShown}){
    ...
    return(
        <div className="how-to-play">
            ...
            <h4>How to Play</h4>
            <p>LinkWord is a word chain daily puzzle that you can solve and compete with your friends. The game consists of a 4 word-chain composed of 3,
            ...
            <br></br>
            <p>Example: "Crushed" - "?" - "?" - "Bottle" will be given and you will guess the 2 words represented by question marks.
